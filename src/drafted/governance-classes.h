 ...
 *
 *   // network
 *   CVivoinnovaonexgobyteNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.vivoinnovaonexgobyte.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CVivoinnovaonexgobyteNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CVivoinnovaonexgobyteNetwork(UniValue objIn)
    {
...
// // can be under: VivoinnovaonexgobyteNetwork
// //   -- signature requirements : Key1(User)
// class CVivoinnovaonexgobyteNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == VivoinnovaonexgobyteNetwork);
//     // }
