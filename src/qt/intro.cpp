...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Vivoinnovaonexgobyte Core"),
     ...
     * override -datadir in the vivoinnovaonexgobyte.conf file in the default data directory
     * (to be consistent with vivoinnovaonexgobyted behavior)
     */
    if(dataDir != getDefaultDataDirectory())
